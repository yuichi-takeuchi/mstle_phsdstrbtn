function ds_Takeuchi3_1A1D_20k_to_500(prefix, date, expNo, sessionNo)
%   ytake 2020
...
[ flag ] = lfpprepf_Takeuchi3_with1A1D( datFileNameBase, metaInfo.sr, metaInfo.srLFP, metaInfo.nChannels);
fprintf('flag = %d\n', flag)
end
