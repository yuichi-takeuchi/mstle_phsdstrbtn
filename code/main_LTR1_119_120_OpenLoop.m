...
metainfo = {
    'AP', 190716, 1, 2, [119 120], [21 8];
    'AP', 190717, 1, 2, [119 120], [21 8];
    };
...
cidx = {
    1, 1, [], repmat([1 0],1,6); % record num of metainfo, rat No, rejection trial no, trues for trials to be analyzed
    1, 2, [11 12], repmat([0 1],1,5);
    2, 1, [], repmat([1 0],1,6);
    2, 2, [1 2 5 6], repmat([0 1],1,4);
    };
for i = 1:size(cidx, 1)
