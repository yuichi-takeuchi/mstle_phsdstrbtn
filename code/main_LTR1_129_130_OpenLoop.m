...
metainfo = {
    ...
    'AP', 200817, 2, 1, [129 130], [7 7];
    'AP', 200817, 2, 2, [129 130], [7 7];
    'AP', 200819, 3, 1, [129 130], [7 7];
    'AP', 200819, 3, 2, [129 130], [7 7];
    };
...
cidx = {
    1, 1, [7 8], repmat([1 0],1,3); % record num of metainfo, rat No, rejection trial no, trues for trials to be analyzed
    1, 2, [7 8], repmat([0 1],1,3);
    2, 1, [], repmat([1 0],1,4); % record num of metainfo, rat No, rejection trial no, trues for trials to be analyzed
    2, 2, [], repmat([0 1],1,4);
